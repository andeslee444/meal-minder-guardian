  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'elegant-hover': '0 1px 3px rgba(0,0,0,0.03), 0 8px 20px rgba(0,0,0,0.08)',
        card: '0 2px 10px rgba(0,0,0,0.03), 0 10px 30px rgba(0,0,0,0.05)',
        menu: '0 2px 5px rgba(0,0,0,0.02), 0 10px 30px rgba(0,0,0,0.08)',
      },
      backdropBlur: {
        xs: '2px',
      },
